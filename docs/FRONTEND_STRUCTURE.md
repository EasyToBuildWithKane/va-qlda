...
| `components/VendorFormModal.vue` + `VendorFormFields.vue` | Modal thêm/sửa NCC: `fit-viewport` `max-w-5xl`, form ngang 3 cột, loại dịch vụ = lưới chip `lg:grid-cols-3` + ô tự thêm (`category_names`) |
