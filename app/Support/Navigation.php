            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'href' => '/work',
                        'status' => 'live',
                        'roles' => ['admin', 'manager', 'deputy_manager', 'team_leader', 'viewer'],
                    ],
                ],
            ],
            ...
            [
                ...
                'items' => array_values(array_filter([
                    ...
                    [
                        ...
                        'status' => 'live',
                        'roles' => ['admin', 'manager', 'deputy_manager', 'team_leader'],
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'href' => '/my-work',
                        'status' => 'live',
                        'roles' => ['admin', 'manager', 'deputy_manager', 'team_leader', 'member'],
                    ],
                    [
                        'label' => 'Tất cả dự án',
                        'icon' => 'all-projects',
