 ...
 */
export function exportBlockers({ list, projectCode = 'DA', projectName = '', format = 'xlsx' }) {
    ...
    if (format === 'csv') {
        ...
        a.download = `VA_VuongMac_${code}_${dd}${mm}${yyyy}.csv`;
        a.click();
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Vướng mắc');
    XLSX.writeFile(wb, `VA_VuongMac_${code}_${dd}${mm}${yyyy}.xlsx`);
}

/** @deprecated dùng exportBlockers */
export const exportRiskBlockers = exportBlockers;
