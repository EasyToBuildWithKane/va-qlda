...
<template>
    <div class="h-full space-y-3 overflow-y-auto overflow-x-hidden pr-1">
        ...
        >
            ...
            >
                ...
                <div class="min-w-0 flex-1">
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <Badge v-if="s.status" :label="s.status.label" :color="s.status.color" />
            ...
            <div v-if="expandedSprints.has(s.id)" class="border-t border-slate-100 px-3 py-3 dark:border-slate-800">
                <p v-if="!(tasksBySprint[s.id] || []).length" class="py-4 text-center text-sm text-slate-400">
                            ...
                            >
                                <div class="flex items-center justify-between gap-1 px-2 py-2">
                                    <span class="flex min-w-0 items-center gap-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200">
                                        <span class="h-1.5 w-1.5 shrink-0 rounded-full" :class="dotClass(col.color)"></span>
                                ...
                                <div class="min-w-0 space-y-1.5 px-1.5 pb-2">
                                    ...
                                    />
                                    <p v-if="col.tasks.length === 0" class="px-1 py-4 text-center text-[10px] text-slate-400">
                                        Trống
                                    </p>
                                </div>
                            </div>
        ...
        >
            ...
            <div v-if="expandedSprints.has('backlog')" class="space-y-3 border-t border-slate-200 px-3 py-3 dark:border-slate-700">
                <div
                        ...
                        >
                            ...
                            <div class="min-w-0 space-y-1.5 px-1.5 pb-2">
                                <TaskCard
                                    ...
                                    @dragstart="dragId = task.id"
                                />
                                <p v-if="col.tasks.length === 0" class="px-1 py-4 text-center text-[10px] text-slate-400">Trống</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <p v-if="!sprints.length && !tasks.length" class="py-12 text-center text-sm text-slate-400">
