        ...
        >
            ...
            >
                <div class="card w-full max-w-md p-6 shadow-elevation-3">
                    <h2 v-if="dialogState.title" class="font-display text-lg font-semibold text-slate-800">
                        {{ dialogState.title }}
                    </h2>
                    <p v-if="dialogState.message" class="mt-1 text-sm leading-relaxed text-slate-600">
                        {{ dialogState.message }}
                    </p>
