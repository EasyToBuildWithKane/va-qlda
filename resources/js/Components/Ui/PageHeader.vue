    ...
    <div class="flex items-center gap-2.5 min-w-0">
        ...
        <div class="min-w-0 flex-1">
            <div class="flex items-center gap-2 flex-wrap">
                <h1 class="text-[15px] font-semibold text-slate-800 leading-tight truncate">{{ title }}</h1>
                <span
            ...
            <p v-if="subtitle" class="text-[12px] text-slate-400 leading-tight mt-0.5 truncate">{{ subtitle }}</p>
        </div>
