    ...
    <div class="grid gap-5 sm:grid-cols-2">
      <div class="sm:col-span-2">
        <CredentialFieldLabel
          for-id="grant-account"
          label="Tài khoản hệ thống"
          required
          tooltip="Gõ tên hoặc username để tìm. Chỉ người được cấp mới xem được nội dung tài khoản theo quyền đã chọn."
          wide
        />
        <SearchSelect
          id="grant-account"
      ...
      <div class="sm:col-span-2">
        <CredentialFieldLabel
          label="Quyền được cấp"
          required
          tooltip="Chọn ít nhất một quyền. «Sao chép mật khẩu» luôn được ghi nhật ký audit."
          wide
        />
