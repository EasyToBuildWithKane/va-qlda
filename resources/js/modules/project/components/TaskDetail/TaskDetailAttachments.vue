  ...
  <section class="rounded-xl border border-slate-200/80 dark:border-slate-700">
    ...
    >
      ...
      <p class="mt-2 text-xs text-slate-500">
        Kéo thả PDF, Office, ZIP, hình ảnh, video (tối đa 10MB/file)
      </p>
    </div>
    ...
    >
      ...
      >
        <div class="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-slate-100 dark:bg-slate-800">
          <AppIcon
            :name="f.is_image ? 'image' : 'documents'"
            :size="16"
        ...
        <div class="min-w-0 flex-1">
          <a
            ...
            target="_blank"
            rel="noopener"
            class="truncate text-sm font-medium text-slate-800 hover:text-brand dark:text-slate-100"
          >
            {{ f.original_name }}
          </a>
