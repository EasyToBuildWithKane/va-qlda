    ...
    <div class="space-y-3">
      <div class="grid grid-cols-2 gap-3">
        <div class="rounded-card bg-slate-50 p-3">
          ...
          <p class="mt-1 font-display text-lg font-bold text-slate-800">
            {{ currency(cost.budget) }}
          </p>
        </div>
        <div class="rounded-card bg-slate-50 p-3">
          <p class="text-xs text-slate-500">
          ...
          <p
            class="mt-1 font-display text-lg font-bold"
            :class="overBudget ? 'text-danger' : 'text-brand'"
          >
        ...
        <div class="rounded-card bg-slate-50 p-3">
          ...
          <p class="mt-1 font-display text-lg font-bold text-slate-800">
            {{ hours(cost.total_hours) }}
          </p>
        </div>
      </div>

      <div
        v-if="cost.by_member?.length"
